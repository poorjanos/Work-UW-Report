...
* Ez a riport havonta követi az érkezéstõl menesztésig tartó szakasz
    + fõ teljesítménymutatóinak változását,
    + volumenének alakulását és
    + a manuális folymamat emberi erõforrásigényét
...
* Hibaág: az ajánlat feldolgozását meg kell szakítani és **csak külsõ input beérkezése esetén folytatható**, tipikusan hiánypótlás, hibakezelés, kockázatelbíráláshoz adatbekérés (exception flow)
...
* A Casco és Élet módoztok tipikusan lassabban kötvényesíthetõk, mint a Lakás  és GFB termékek


### Ezen az ábrán külön mutatjuk meg a négy fõ **termékvonal** teljesítménymutatóit az **automatikus** és a **manuális** folyamatban
...
***
* Az automatikus kötvényesítés részaránya változtik a termékvonalak között.


### Ezen az ábrán az az **automatikus kötvényesítás havi sikerarányát** mutatjuk meg
...
g <- t_page2_5 %>%  
  ...
  labs(
    y = "Automatikus menesztés részaránya",
    x = "Idõszak"
  ) +
  theme(
...
***
* Az automatikus kötvényesítés részaránya a havi menesztett állományban.


### Ezen az ábrán az az **automatikus kötvényesítás havi sikerarányát** mutatjuk meg **termékvonalanként**
...
***
* Az automatikus kötvényesítés részaránya a havi menesztett állományban termékvonalanként.
...
***
* **Erõforrásigény:** adott idõszakban menesztett állomány mnuális kezelésében felhasznált teljes FTE (full-time equivalent = teljes állásban foglalkoztatott dolgozó)
